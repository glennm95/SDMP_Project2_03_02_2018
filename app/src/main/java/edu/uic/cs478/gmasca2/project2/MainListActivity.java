...
//        MenuItem remove = menu.getItem(1);
        ...
        SubMenu removeSongOption = menu.getItem(1).getSubMenu();
        for(int i=0;i<songList.size();i++)
            removeSongOption.add(Menu.NONE,i+100,Menu.NONE,songList.get(i).getSongName());

        MainListActivity mla = new MainListActivity();
